...
//	{
 ...
 $rss= "<a href=\"rss.php?user=".$user["id"]."\" ><img align=center border=0 src=\"pic/rss_small.png\" alt=\"RSS\" /></a>";
?>
...
if (isset($torrents))
  print("<tr valign='top'><td class='rowhead'>Uploaded&nbsp;torrents</br>$rss</td><td align='left'>$torrents</td></tr>\n");
if (isset($seeding))
